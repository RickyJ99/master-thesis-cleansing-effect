...
\[k_t = \frac{k_{t-1}(1 - \delta) - \left[\frac{R_f}{p}  -\frac{ 1-p }{ p }\frac{f(k_{t-1})}{l \cdot k_t}\right] \cdot l k_{t-1} + l k_{t}
+ f(k_{t-1}) - d_{t-1}}{l-1}\]
...
\frac{f(k_{t-1})}{l k_{t-1}}\right) \cdot l k_{t-1} + l k_t
+ f(k_{t-1}) - d_{t-1}\right]{l-1}^{-1}\]
We optimize for \(d_t,k_t
\quad \forall t\), we get the following  focs:
\begin{equation}
    \begin{aligned}
    U'(d_0) &= \frac{\lambda_0}{l-1} , \\
    U'(d_1) &= \frac{\lambda_1}{l-1}, \\
    & \vdots \\
    U'(d_{t}) &= \frac{\lambda_t}{l-1}, \\
    & \vdots \\
    U'(d_{T}) &= \frac{\lambda_T}{l-1}.
    \end{aligned}
\end{equation}
...
\begin{equation}
    \begin{aligned}
        \lambda_0 &= \beta \frac{\lambda_1}{l-1} \left[ f'(k_1) + (1 - \delta) + \frac{ 1-p }{ p } f^{\prime}(k_{1}) - \frac{R_f}{p}l \right], \\
        \beta \lambda_1 &= \beta^2 \frac{\lambda_2}{l-1} \left[ f'(k_2) + (1 - \delta) + \frac{ 1-p }{ p } f^{\prime}(k_{2}) - \frac{R_f}{p}l\right],\\
        & \vdots \\
        \beta^t \lambda_t &= \beta^{t+1} \frac{\lambda_{t+1}}{l-1} \left[ f'(k_{t+1}) + (1 - \delta) + \frac{ 1-p }{ p } f^{\prime}(k_{t+1}) - \frac{R_f}{p}l\right],\\
        & \vdots \\
        \beta^{T-1} \lambda_{T-1} &= \beta^T \frac{\lambda_{T}}{l-1} \left[ f'(k_T) + (1 - \delta) + \frac{ 1-p }{ p } f^{\prime}(k_{T}) - \frac{R_f}{p}l\right], \\
        \beta^T \mu &= \beta^{T+1} \frac{\lambda_{T}}{l-1}.
    \end{aligned}
\end{equation}

thus the euler dividens equation becames:
\[U^{\prime}\left(d_{t}\right)=\frac{\beta}{l-1}
...
Compare to the previus steady state the capital is higher the case free of debt.
