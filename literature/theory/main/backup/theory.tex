...
that the creation rate of new jobs is slower before the crisis spreads out and than the destruction rate increases when it is
not possible to fully accommodate the decrease in demand only stopping new labor hiring. They asses that during the
Great Recession this pattern changed in particular the fraction of net employment contraction accounted by a job
