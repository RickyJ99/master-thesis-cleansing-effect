...
\begin{abstract}
    This thesis formulates a Ramsey-Cass-Koopmans theoretical model, addressing the complex scenario
    wherein firms, intent on dividend maximization, grapple with financial frictions encompassing both monitoring costs
    and fixed leverage constraints. A pivotal achievement of this work is the derivation of a closed-form solution to
    the firms' infinite intertemporal maximization problem, encapsulated within the participation constraints of
    financial lenders,  underpinned by monitoring expenditures and financing constraints.
    Employing a Lagrangian framework, I extract the Euler equation for dividends, thereby
    uncovering the fundamental principles guiding optimal dividend policies in the face of financial constraints. 

    Building on the analytical groundwork, the thesis employs Monte Carlo simulations to investigate the behavior of
    heterogeneous firms—varied in terms of leverage and productivity—under the influence of business cycles. It uncovers
    that the 'cleansing effect,' which fosters a reallocation of resources during economic downturns, leads to a 20\%
    augmentation in the overall output of the economy in scenarios devoid of monitoring costs. However, this effect is
    attenuated to a 7\% increase when firms are subject to a 15\% monitoring cost.
    This empirical evidence, aligning with insights from \cite{OsePap17}, confirms the theoretical propositions
    regarding the modulating role of financial frictions on the cleansing effect.
    
    In conclusion, this thesis contributes significantly to the literature by providing a comprehensive analysis of how
    financial frictions impact firm behavior and the overall economic landscape. By developing a
    model that captures the effects of such frictions on firm dynamics and leveraging empirical evidence to
    validate theoretical insights. This endeavor sets the stage for subsequent investigative efforts in the field.
\end{abstract}
...
In macroeconomic theory, the dynamic interplay between business cycles and long-term economic growth poses a complex
challenge, drawing a parallel to the reconciliation efforts between quantum mechanics and Einstein's theory of
relativity in physics. This traditional academic compartmentalization tends to overlook a crucial question: how do
business cycles affect long-term economic growth? Investigating this query is essential, as it sheds light on the
implications of short-term economic policies for the broader economic trajectory.

This thesis focuses on the dynamics of firm optimization amidst financial frictions, bridging theoretical constructs
with practical economic phenomena. A significant portion of this research is devoted to understanding how financial
market frictions might
influence the 'cleansing effect' of reallocation. This effect, akin to natural selection, is scrutinized for its potential
long-term impacts on economic stability and growth.

Inspired by biological cycles and their long-term trends, described in Lotka-Volterra equations, this work draws an analogy to economic cycles, suggesting that
short-term fluctuations may conceal underlying growth patterns. Similar to biological interventions that might initially
seem beneficial, economic policies aimed at stabilizing cycles could inadvertently hinder the natural selection process,
leading to unforeseen long-term consequences.

Employing a biological analogy, this thesis hypothesizes that recessions can act as a natural selection mechanism
within economies, purging less efficient firms and promoting more productive ones. Through theoretical models and Monte
Carlo simulations, this research endeavors to elucidate the relationship between short-term economic fluctuations and
long-term growth. The thesis particularly emphasizes solving firms' intertemporal maximization problems under financial
constraints through a closed-form solution, spotlighting the significant influence of financial frictions.
...
This thesis marks a significant departure from prior studies that predominantly rely on numerical methods by offering a
closed-form solution for determining the optimal trajectories of capital and dividends. Such a breakthrough provides a
nuanced understanding of the intertemporal maximization challenges faced by firms. This research delves into the
repercussions of credit frictions on the cleansing effect observed during recessions within a framework encompassing
firm dynamics, credit restrictions, and mechanisms for firm exit. It is found that, even in the presence of credit
frictions, recessions exert a cleansing effect by enabling the redistribution of resources to more efficient entities. 

Credit constraints within the model are endogenously driven by asymmetric information and the costs associated with
verifying states. Incorporating a one-period financial contract, mirroring the methodology proposed by \cite{BerGer86},
into the model of firm dynamics, allows for the delineation of borrowing capabilities and the determination of interest
rates by financial intermediaries, which are contingent upon each firm's productivity and leverage. Additionally, the
model imposes a borrowing constraint on firms, stipulating that leverage is exogenous and remains constant over time. 

Following the theoretical developments, this thesis employs Monte Carlo simulations to rigorously analyze the behavior
of firms differentiated by their productivity and leverage ratios in the face of business cycle fluctuations. These
fluctuations are modeled as continuous sinusoidal shocks to the productivity component, simulating the dynamic pressures
of economic cycles. A key feature of the model is the exit mechanism, which compels firms to exit the market if their
return on capital falls below the risk-free rate, directly engaging with the discourse on the cleansing effect of
recessions. 

The heterogeneity in firm characteristics, notably in terms of productivity and leverage, allows for a detailed
examination of how diverse firms respond to economic cycles and credit constraints. Firms with higher leverage may face
...
The simulations reveal that recessions facilitate a significant enhancement in the economy's overall output by enabling
the reallocation of resources towards more efficient firms, particularly in scenarios devoid of monitoring costs.
However, the introduction of such costs tempers this efficiency gain, underscoring the nuanced role that financial
frictions play in influencing the economy's adaptive capacity during downturns. This observed cleansing effect, albeit
modulated by the presence of financial frictions, substantiates the theoretical assertions posited earlier in the
thesis. 

Moreover, this empirical evidence, resonating with the findings from \cite{OsePap17}, affirms the contention that,
despite the dampening influence of credit constraints, recessions retain an inherent capacity to purge the economy of
less efficient firms. This mechanism, facilitated by a well-defined exit criterion based on returns relative to the
risk-free rate and nuanced by firm-specific attributes of productivity and leverage exemplifies the complex interplay
between financial frictions, firm dynamics, and economic resilience under cyclical pressures. 

The initial segment of this thesis introduces the theoretical frameworks of \cite{CabHarm94} and \cite{OsePap17}, aiming
to highlight how the incorporation of financial frictions alters previously established results in the literature.
Following this introduction, the thesis delves into the formulation of theoretical models that explore the dynamics of
capital flow and debt in financial contracts. An examination of the firm's problem in the absence of debt, mirroring the
Ramsey-Cass-Koopmans model where consumption is represented by dividends and leverage, employs a Lagrangian approach to
derive the Euler equation for dividends. This equation serves as the cornerstone for determining the optimal policies
for dividends and investment. Utilizing the derived solution, a phase diagram for capital and dividends is constructed
to identify a potential saddle path toward a stationary state for both variables.

Subsequently, the theoretical model is expanded to accommodate the firm's ability to finance investment through debt,
subjecting it to financial frictions manifested as monitoring costs and borrowing constraints. By applying the
Lagrangian method, steady-state conditions for dividends are extracted from the Euler equation, along with consolidation
constraints to ascertain the steady-state condition for capital. These findings enable the plotting of a phase diagram
for capital and dividends, illustrating their interrelation.

Reformulating the problem through a Bellman equation and employing a guess-and-verify approach yields the optimal path
for capital, policy function for dividends, and the steady state for capital. 

In the concluding part, these results underpin simulations that assess the impact of monitoring costs on capital,
demonstrating significant reductions in capital levels due to such costs. Monte Carlo simulations further explore
economies with heterogeneous firms, characterized by variations in leverage and productivity. Firms in this model are
compelled to exit if their return on capital falls below the risk-free rate, enabling an examination of the cleansing
effect of recessions in the context of financial frictions. This multifaceted analysis offers insightful conclusions
about the influence of financial frictions on firm behavior, the allocation of resources, and the overall efficiency of
the economy during downturns, thereby contributing to the broader understanding of economic dynamics in the presence of
...
To derive the optimal trajectories for capital and dividends, as well as the steady-state locus for capital in the
...
To refine our model, we introduce heterogeneity among firms, marking a departure from uniform productivity.
...
In our investigation, financial frictions are integrated into the economic model, characterized by a monitoring cost
...
This thesis presents a comprehensive theoretical model that elucidates the intertemporal optimization problem of firms
contending with financial frictions. By integrating mechanisms for financing through retained earnings and debt within
the framework of the Ramsey-Cass-Koopmans model, this work embarks on an analytical journey starting with the
application of Lagrangian methods to establish steady-state conditions. It progresses to leveraging the Bellman
equation, in conjunction with guess and verify techniques, to extract explicit solutions for the paths of capital
accumulation and dividend distribution across an infinite timeline. This rigorous approach facilitates an in-depth
exploration of the impacts of financial frictions, such as monitoring costs and financing constraints, on the
formulation of firms' optimal strategies for capital and dividend management.

Empirical analysis, informed by the parameterization in \cite{OsePap17}, demonstrates that substantial monitoring costs
— 25\% of recoverable assets — can lead to a significant reduction in the steady-state level of capital, by up to 69\%.
This highlights the profound effect of financial frictions on the dynamics of firm valuation and asset management.

Monte Carlo simulations further extend this analysis to a heterogeneous firm population, characterized by diverse
productivity levels and leverage ratios. These simulations assess the impact of capital reallocation following firms'
exits in a financial friction-laden environment. Results reveal that such reallocation can boost the economy's total
output by approximately 10\% under a financial framework with 15\% monitoring costs. Remarkably, the absence of
monitoring costs escalates the enhancement in total output to around 20\%, validating that while financial frictions may
reduce the cleansing effect's magnitude, its overall impact remains positive. This aligns with findings from
\cite{OsePap17}, reinforcing the intricate relationship between financial frictions, firm exit strategies, and economic
productivity.

This thesis contribution is to elucidate the dynamic interplay between financial frictions, firm operational behavior,
and the broader market ecosystem. It ascertains that financial frictions, albeit challenging, do not fully negate the
benefits derived from market-induced capital reallocation. Market dynamics, through inherent exit and entry mechanisms,
significantly mitigate the adverse effects of financial frictions, maintaining or even amplifying economic output under
certain conditions.

Future research avenues are manifold and promise to enrich our understanding by introducing uncertainty into the model
to increase its realism and applicability across different economic scenarios. Incorporating stochastic shocks into firm
productivity and the intensity of financial frictions could provide insights into firms' strategic responses under
uncertainty. Additionally, examining policy interventions targeting firms under financial duress could yield
recommendations for minimizing unwarranted firm exits and enhancing economic output. Extending the model to account for
endogenous firm exit and entry decisions, broadening the spectrum of firm heterogeneity, and exploring the role of
financial institutions in mediating financial frictions' effects could unravel further dimensions of the complex
relationship between financial markets and real economic activity.
\medskip
