...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \pgfplotstableread[col sep=comma, row sep=newline]{output_data/noexit_nofriction_stats.csv}\datatable
        
        % Plot mean Total_production_actual
        \addplot [name path=mean_actual, blue, mark=none] table [x=Step, y=Total_Production_actual_mean] {\datatable};
        \addlegendentry{Actual Mean}
        
        % Plot mean Total_production_optimal
        \addplot [name path=mean_optimal, red, mark=none] table [x=Step, y=Total_Production_optimal_mean] {\datatable};
        \addlegendentry{Optimal Mean}
        
        % Plot CI for Total_production_optimal as grey area
        \addplot [name path=upper_optimal, draw=none] table [x=Step, y=Total_Production_optimal_CI_Upper] {\datatable};
        \addplot [name path=lower_optimal, draw=none] table [x=Step, y=Total_Production_optimal_CI_Lower] {\datatable};
        \addplot [fill=gray!40] fill between[of=upper_optimal and lower_optimal];
        \addlegendentry{Optimal CI}
        
        % Plot CI for Total_production_actual as grey area
        \addplot [name path=upper_actual, draw=none] table [x=Step, y=Total_Production_actual_CI_Upper] {\datatable};
        \addplot [name path=lower_actual, draw=none] table [x=Step, y=Total_Production_actual_CI_Lower] {\datatable};
        \addplot [fill=gray!40] fill between[of=upper_actual and lower_actual];
        \addlegendentry{Actual CI}
        \end{axis}
    \end{tikzpicture}
