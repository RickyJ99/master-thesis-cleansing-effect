...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \addlegendentry{Actual Mean (No Exit)}
        ...
        \addlegendentry{Actual Mean (Exit)}
        ...
        \addplot+ [
            ...
            mark=none, % No marks at data points; use mark=* if you want marks
            line width=1pt, % Adjust line width as needed
            error bars/.cd,
            y dir=both, y explicit,
            error bar style={color=black},
            error mark options={
                rotate=90,
                mark size=2pt, % Adjust size of the marks at the tips of the error bars
                color=black
            }
        ] table [
            x=Step,
            y=Total_Production_actual_diff_mean,
            y error plus expr=\thisrow{Total_Production_actual_diff_CI_Upper}-\thisrow{Total_Production_actual_diff_mean},
            y error minus expr=\thisrow{Total_Production_actual_diff_mean}-\thisrow{Total_Production_actual_diff_CI_Lower}
        ] {\datatableDiff};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \addlegendentry{Difference with CI}
