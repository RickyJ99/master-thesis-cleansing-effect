...
\begin{abstract}
    ...
    approach to formulate the Euler equations for dividends and capital, followed by a Bellman equation with a
...
maximization challenge. Remarkably, these results closely mirror those of the Ramsey-Cass-Koopmans model, indicating the
...
However, the introduction of such costs tempers this efficiency gain, underscoring the role that financial
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \addplot[blue] table [col sep=comma, x=l, y=par] {output_data/adjusted_partial_derivative_k_with_respect_to_l.csv}; % With friction
        \end{axis}
