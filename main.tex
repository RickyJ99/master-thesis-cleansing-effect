...
The conceptual foundation of this investigation is inspired by an ecological analogy of the cyclical dynamics observed
...
\chapter{Introducing financial frictions}
...
The exit mechanism is activated if a firm's return on capital is not only below the risk-free rate but also the lowest
compared to all other firms, necessitating its market exit. A new firm then enters the market, acquiring the minimum
available capital from the collective pool of the existing firms. The exiting firm's capital is proportionally
distributed among the remaining firms based on their returns on capital. Additionally, the incoming firm begins with a
starting capital that matches the minimum from the distribution of the capital of exiting firms. 

The formula for calculating the return on capital for a firm \(i\) at time \(t\) is as follows:
\begin{equation}
    R_{i,t} = \frac{d_{i,t-1}}{k_{i,t}} + \frac{k_{i,t}-k_{i,t-1}}{k_{i,t}} 
\end{equation}

A firm is compelled to exit the market if its return on capital is the lowest (\( \min{R_{i,t}} \)) and is less than the
risk-free rate (\(R_f\)). This rule is applied at each time step in the simulation.\footnote{The exit criterion is
evaluated at every step of the simulation to determine if a firm must exit.} 
...
\begin{figure}
    ...
    smaller, at approximately 10\%. Additionally, the error bars indicate a 95\% confidence interval (CI), highlighting
...
Figure \ref{fig:output_comparison_frictions} demonstrates that, even under financial frictions where \(1- \mu =0.15\),
...
productivity and capital among firms will diverge in terms of output and productivity if one allows for capital reallocation
through firm exits. 

\chapter{Conclusions}

This thesis develops a theoretical model that provides a closed-form solution for the intertemporal optimization problem
faced by firms operating under financial frictions. It integrates financing through retained earnings, as conceptualized
in the Ramsey-Cass-Koopmans model, and debt. The analysis begins with the application of Lagrangian methods to determine
the steady state, followed by the employment of the Bellman equation, combined with guess and verify methods, to derive
solutions for capital and dividends over an infinite horizon. This approach allows for a detailed examination of
financial frictions, including monitoring costs and financing constraints, and their effects on firms' optimal
strategies for capital accumulation and dividend distribution. Through this methodology, the thesis advances the
understanding of how financial frictions influence firm behavior and decision-making processes related to capital and
dividends. Drawing upon parameterization aligned with the study
by
\cite{OsePap17}, our analysis reveals that monitoring costs amounting to 25\% of recoverable assets significantly
diminish the steady-state level of capital by as much as 69\%. This finding underscores the substantial influence of
financial frictions on firm dynamics and asset valuation.

Further, through the application of Monte Carlo simulations to a heterogeneously composed firm population—distinguished
by variations in productivity and leverage ratios—we have quantitatively assessed the repercussions of capital
reallocation triggered by firm exits in an environment characterized by financial frictions. The simulations indicate
that such capital reallocation can enhance the total output of the economy by approximately 10\% under financial
constraints involving 15\% monitoring costs. Intriguingly, in the absence of monitoring costs, the cleansing effect
observed through capital reallocation increases to around 20\%, suggesting that while financial frictions may attenuate
the magnitude of the cleansing effect, its overall impact remains decidedly positive. These results are in alignment
with the findings presented in \cite{OsePap17}, further substantiating the nuanced interplay between financial frictions,
firm exit mechanisms, and economic productivity.

In essence, our findings contribute to a deeper understanding of the dynamic interplay between financial frictions, firm
behavior,  and market mechanisms. We demonstrate that financial frictions, though challenging, do not entirely negate
the benefits conferred by market-driven capital reallocation. Instead, the inherent exit and entry dynamics within
markets serve as a significant counterbalance to the dampening effects of such frictions, preserving, and in certain
conditions, enhancing economic output.

Building upon the findings of this thesis, future research can significantly broaden our understanding by incorporating
uncertainty into the model, thereby enhancing its realism and applicability to diverse economic environments. A
promising avenue involves introducing stochastic shocks to the productivity levels of firms and the severity of
financial frictions. This extension would enable an examination of how firms navigate uncertainty and the effectiveness
of strategic decision-making under risk.

Additionally, the analysis of various policy interventions designed to support firms facing financial constraints could
offer valuable insights and recommendations. For instance, evaluating policies that provide financial support to
high-productivity firms experiencing temporary liquidity issues could illuminate their impact on reducing unnecessary
firm exits and preserving economic output.

Expanding the model to include endogenous exit and entry decisions based on economic conditions and firm performance
could also reveal dynamic interactions between firm dynamics and the overall economy. This would allow for a nuanced
understanding of the cleansing effect and its implications for economic resilience and growth.

Incorporating a broader range of heterogeneity among firms, including differences in access to financial markets, market
power, and innovation capacity, could provide a comprehensive picture of the economy. This approach would enable
exploration of how financial frictions affect different segments of the economy and the distributional impacts of policy
interventions.

Furthermore, exploring the role of financial institutions in mediating the effects of financial frictions on firms could
shed light on the mechanisms through which financial markets impact real economic activity. Examining changes in
lending practices, interest rates, and financial regulation could offer insights into how financial institutions
influence firm behavior and economic outcomes.

By addressing these areas, future research can build on this thesis to offer a detailed and nuanced understanding of the
interplay between financial frictions, firm dynamics, and economic policy. Such studies have the potential to inform
policymaking by identifying strategies to mitigate the negative impacts of financial frictions, enhance economic
resilience, and foster sustainable economic growth, thus expanding the horizon of economic research in meaningful and
impactful ways. This thesis, therefore, sheds light on the nuanced roles of financial frictions and market dynamics in shaping firm
strategies and overall economic outcomes. By elucidating the conditions under which financial frictions exert their
influence and identifying pathways for mitigating their effects, this work contributes valuable perspectives to the
discourse on financial economics and firm-level decision-making. As such, it lays the groundwork for future research
aimed at further unraveling the complexities of financial markets and the strategic responses of firms within them,
enhancing our understanding of the resilience mechanisms that underpin economic growth in the face of financial
adversities.
\medskip
